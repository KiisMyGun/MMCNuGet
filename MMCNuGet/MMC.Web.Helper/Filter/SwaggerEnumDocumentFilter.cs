...
namespace MMC.Web.Helper.Filter
{
    /// <summary>
    /// 向Swagger添加枚举值说明
    /// </summary>
    public class SwaggerEnumDocumentFilter : IDocumentFilter
    {
        ...
        /// 程序集程序***.dll
        /// </summary>
        public static string _assemblyString = "***";

        public SwaggerEnumDocumentFilter(string assemblyString)
        {
        ...
        {
            Assembly ass = Assembly.Load(_assemblyString);
